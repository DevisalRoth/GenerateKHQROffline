...
static short INVALID_EMVQR_CODE = 51;
static NSString * INVALID_EMVQR_MESSAGE = @"Invalid EMVQR";

@implementation ErrorConstants

+(NSNumber *) invalidEMVQRCode {
    return [NSNumber numberWithInt: INVALID_EMVQR_CODE] ;
}

+(NSString *) invalidEMVQRMessage {
    return INVALID_EMVQR_MESSAGE;
}
